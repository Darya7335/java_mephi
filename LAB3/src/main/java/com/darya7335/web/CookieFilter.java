...
import com.darya7335.web.entities.LoginPassword;
import com.darya7335.web.entities.SessionId;
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws ServletException, IOException {
        ...
        if (containsSessionId(uuid)) {
            ...
            if (httpRequest.getMethod().equals("POST") || httpRequest.getRequestURI().equals("/"))
                ...
                if ("/LAB3_war_exploded/users_list.jsp".equals(httpRequest.getRequestURI())) {
